...
You are the `doc-model` agent building **Omapresent**, a Markdown-only
...
2. `tasks/T1-document-model.md` — your brief.
...
Also read `docs/renderer-contract.md` — your `toJson()` output is the top half
