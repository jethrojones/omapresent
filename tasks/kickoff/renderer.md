...
You are the `renderer` agent building **Omapresent**, a Markdown-only
...
2. `tasks/T2-renderer.md` — your brief.
...
Also read `docs/renderer-contract.md` **carefully** — it is the frozen interface
between C++ and your bundle, and seven other agents are building against it.
