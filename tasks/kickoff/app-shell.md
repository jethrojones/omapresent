...
You are the `app-shell` agent building **Omapresent**, a Markdown-only
...
2. `tasks/T8-app-integration.md` — your brief.
...
Also read `docs/renderer-contract.md` — you are the host side of that interface.
