...
You are the `media` agent building **Omapresent**, a Markdown-only
...
2. `tasks/T5-media.md` — your brief.
...
Also read `docs/renderer-contract.md` §1 for the \`media\` object your
